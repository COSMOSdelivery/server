...
CREATE TABLE "Commande" (
    ...
    "nom_prioritaire" TEXT NOT NULL,
    "prenom_prioritaire" TEXT NOT NULL,
    "gouvernorat" TEXT NOT NULL,
    "ville" TEXT NOT NULL,
    "localite" TEXT NOT NULL,
    "codePostal" TEXT NOT NULL,
...
CREATE TABLE "FeedbackCommande" (
    ...
    CONSTRAINT "FeedbackCommande_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "FeedbackCommande" ADD CONSTRAINT "FeedbackCommande_id_client_fkey" FOREIGN KEY ("id_client") REFERENCES "Client"("idClient") ON DELETE RESTRICT ON UPDATE CASCADE;
